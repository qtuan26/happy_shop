...
[![Laravel](https://img.shields.io/badge/Laravel-9+-FF2D20?style=flat&logo=laravel&logoColor=white)](https://laravel.com)
...
- [Cài đặt Backend](#-cài-đặt-backend-laravel)
- [Cài đặt Frontend](#-cài-đặt-frontend-react)
...
**Giải pháp:**
1. Kiểm tra file `config/cors.php`:
```php
'paths' => ['api/*'],
...
**Giải pháp:**
1. Kiểm tra token trong `sessionStorage`:
```javascript
console.log(sessionStorage.getItem('token'));
```

2. Kiểm tra header trong request:
```javascript
Authorization: Bearer {token}
```

3. Kiểm tra middleware trong route:
```php
...
<div align="center">
  <p>Made with ❤️ by HappyShop Team</p>
  <p>© 2024 HappyShop. All rights reserved.</p>
</div>